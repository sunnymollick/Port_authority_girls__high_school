   ...
   public function allUser()
   {
      ...
      return Datatables::of($users)
        ...
        ->addColumn('action', function ($users) use ($can_edit, $can_delete) {
           ...
           $html .= '<a data-toggle="tooltip" ' . $can_edit . '  id="' . $users->id . '" class="btn btn-xs btn-primary margin-r-5 edit" title="Edit"><i class="fa fa-edit fa-fw"></i> </a>';
           $html .= '<a data-toggle="tooltip" ' . $can_delete . ' id="' . $users->id . '" class="btn btn-xs btn-danger margin-r-5 delete" title="Delete"><i class="fa fa-trash-o fa-fw"></i> </a>';
           $html .= '</div>';
           return $html;
        })
