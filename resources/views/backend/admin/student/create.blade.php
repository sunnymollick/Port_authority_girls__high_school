<form id='create' action="" enctype="multipart/form-data" method="post" accept-charset="utf-8">
    ...
    <div class="form-group col-md-6 col-sm-12">
        ...
        <input type="text" class="form-control" id="std_code" name="std_code" value=""
               placeholder="" required>
...
<div class="row">
    <div class="col-md-12 import_notice">
        <p> Please Follow The Instructions While Adding New Student: </p>
        <ol>
            <li>Please fill up all required field</li>
            <li>Check the running year/session in setting menu</li>
            <li>Student code must be unique and both student and parent code must be same</li>
            <li>Check the student optional subject. Choose optional subject when subject insert</li>
        </ol>
        <span>
            ***This System Keeps Track Of Duplication In Student Code, Parent ID and Email. So Please Enter
            Unique Student Code, Parent ID and Email For Every Student. </span>
    </div>
</div>
    ...
    function get_class_sections(val) {
        ...
        $.ajax({
            ...
            error: function (result) {
                $("#class_section_id").html("Sorry Cannot Load Data");
            }
        });
    }
