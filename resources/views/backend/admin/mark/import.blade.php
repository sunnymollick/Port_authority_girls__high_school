            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    <p class="panel-title"> Import Marks
                        <a style="color: #fff" href="{{ $session_year->special == 0? asset('assets/documents/marks_import_file.xlsx'): asset('assets/documents/marks_import_file_demo.xlsx') }}"
            ...
            $('#create').validate({// <- attach '.validate()' to your form
                ...
                submitHandler: function (form) {
                    ...
                    swal({
                        ...
                        $.ajax({
                            url: '{!! route('admin.importMarks.import') !!}',
                            type: 'POST',
                            data: myData,
                            dataType: 'json',
                            cache: false,
