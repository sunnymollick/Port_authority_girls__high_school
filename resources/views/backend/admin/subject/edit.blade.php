<form id='edit' action="" enctype="multipart/form-data" method="post" accept-charset="utf-8">
    ...
    <div class="form-group col-md-3 col-sm-12">
        ...
        <input type="number" class="form-control decimal" max="100" min="0" id="pass_marks" name="pass_marks" value="{{$subject->pass_marks}}"
               placeholder="" required>
        <span id="error_pass_marks" class="has-error"></span>
    </div>
    <div class="form-group col-md-3 col-sm-12">
        <label for=""> Theory Marks </label>
        <input type="number" class="form-control decimal" max="100" min="0" id="theory_marks" name="theory_marks"
    ...
    <div class="form-group col-md-3 col-sm-12">
        ...
        <input type="number" class="form-control decimal" max="100" min="0" id="theory_pass_marks" name="theory_pass_marks"
    ...
    <div class="form-group col-md-2 col-sm-12">
        ...
        <input type="number" class="form-control decimal" max="100" min="0" id="mcq_marks" name="mcq_marks" value="{{$subject->mcq_marks}}"
               placeholder="">
        <span id="error_mcq_marks" class="has-error"></span>
    </div>
    <div class="form-group col-md-3 col-sm-12">
        <label for=""> MCQ Pass Marks </label>
        <input type="number" class="form-control decimal" max="100" min="0" id="mcq_pass_marks" name="mcq_pass_marks"
    ...
    <div class="form-group col-md-2 col-sm-12">
        ...
        <input type="number" class="form-control decimal" max="100" min="0" id="practical_marks" name="practical_marks"
    ...
    <div class="form-group col-md-3 col-sm-12">
        ...
        <input type="number" class="form-control decimal" max="100" min="0" id="practical_pass_marks" name="practical_pass_marks"
    ...
    <div class="form-group col-md-2 col-sm-12">
        ...
        <input type="number" class="form-control decimal" max="100" min="0" id="ct_marks" name="ct_marks" value="{{$subject->ct_marks}}"
               placeholder="">
