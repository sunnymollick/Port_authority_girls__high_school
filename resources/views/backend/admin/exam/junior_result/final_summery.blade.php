@if(!empty($data))
    ...
    <div class="row">
        ...
        @php
            ...
            $exam_name = 'Class ' . $data['class_name'] . ' Final Exam'; // $data['exam_name_final'] ;
            ...
            @foreach($data['result'] as $row)
                <tr>
                    ...
                    <td class="text-center"><a data-toggle='tooltip' title='View Tabulation Sheet'
                                               ...
                                               std_code="{{ $row->student_code }}"> View </a>
                    </td>
                </tr>
            @endforeach
            </tbody>
    ...
    $("#manage_all").on("click", ".view", function () {
        ...
        $.ajax({
            ...
            data: {
                ...
                "std_roll": std_roll,
                "exam_name_half": "{{ $data['exam_name_half'] }}",
                "exam_name_final": "{{ $data['exam_name_final'] }}",
                "section_name": "{{ $data['section_name'] }}",
                "class_name": "{{ $data['class_name'] }}",
                "_token": CSRF_TOKEN
            },
